...
test.describe('Add to cart tests', () => {
  ...
  test('Should update card on product add from details page', async ({
    homePage,
    productDetailPage,
  }) => {
    ...
    await expect
      .soft(await productDetailPage.getSuccessMessage())
      .toHaveText(`You added ${productName} to your shopping cart.`);
